...
// Z1013 adaptation: clk_audio is a synchronous sample pulse observed in the
// existing pixel-clock domain. It is deliberately not used as a clock tree.
logic clk_audio_old = 1'b0;
